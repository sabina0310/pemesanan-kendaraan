...
<!-- Content Header (Page header) -->
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-newspaper"></i> Servis</h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Daftar Servis</h3>
                <div class="card-tools">
                <a href="index.php?include=tambah-servis" 
                  class="btn btn-sm btn-info float-right">
                  <i class="fas fa-plus"></i> Tambah Servis</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="col-md-12">
                ...
                $batas = 10;
                  ...
                  if(!isset($_GET['halaman'])){
                    ...
                    from `servis` `s` INNER JOIN `kendaraan` `k` ON `s`.`id_kendaraan` = `k`.`id_kendaraan`";
              ...
              if($jum_halaman==0){
                //tidak ada halaman
                  ...
                  if($halaman!=1){
                    ...
                    href='index.php?include=servis&halaman=1'>First</a></li>";
                    echo "<li class='page-item'><a class='page-link' 
                    href='index.php?include=servis&halaman=$sebelum'>«</a></li>";
                  }
                  for($i=1; $i<=$jum_halaman; $i++){
                    if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                      if($i!=$halaman){
                          echo "<li class='page-item'><a class='page-link' 
                          href='index.php?include=servis&halaman=$i'>$i</a></li>";
                      }else{
                  ...
                  if($halaman!=$jum_halaman){
                    echo "<li class='page-item'><a class='page-link' 
                    href='index.php?include=servis&halaman=$setelah'>»</a></li>";
                    echo "<li class='page-item'><a class='page-link' 
                    href='index.php?include=servis&halaman=$jum_halaman'>Last</a></li>";
                  }
